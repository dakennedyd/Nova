...
namespace Nova {
	...
	public:
		...
		/*Unregister the entity from the system. if the entity is already unregistered then it does nothing*/
	...
	private:		
		...
		//stores only the components that are of interest to this system(only one of each type of component is allowed)
