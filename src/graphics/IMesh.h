...
class IMesh : public Bindable, public ResourceBase
{
  public:
    ...
    virtual const int getMode() const = 0;			//what mode the mesh is in triangles, lines,
    points etc virtual const Mat4& getModelMatrix() const = 0; virtual void setModelMatrix(Mat4
    model) = 0;*/
