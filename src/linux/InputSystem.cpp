...
namespace Nova {
	void keyCallback(GLFWwindow* window, int key, int scancode, int action, int mods)
	{
		...
		const std::string& actionString(EngineSettings::getInstance().getString("Default-ActionContext",
			is.getKeyString(key)));
	...
	void mouseButtonCallback(GLFWwindow* window, int button, int action, int mods)
	{
		...
		const std::string& actionString(EngineSettings::getInstance().getString("Default-ActionContext",
			is.getMouseButtonString(button)));
	...
	void InputSystem::startUp()
	{
		...
		mKeyMap[Keys::KEY_A] = "key_a"; mKeyMap[Keys::KEY_B] = "key_b"; mKeyMap[Keys::KEY_C] = "key_c";
		mKeyMap[Keys::KEY_D] = "key_d"; mKeyMap[Keys::KEY_E] = "key_e"; mKeyMap[Keys::KEY_F] = "key_f";
		mKeyMap[Keys::KEY_G] = "key_g"; mKeyMap[Keys::KEY_H] = "key_h"; mKeyMap[Keys::KEY_I] = "key_i";
		mKeyMap[Keys::KEY_J] = "key_j"; mKeyMap[Keys::KEY_K] = "key_k"; mKeyMap[Keys::KEY_L] = "key_l";
		mKeyMap[Keys::KEY_M] = "key_m"; mKeyMap[Keys::KEY_N] = "key_n"; mKeyMap[Keys::KEY_O] = "key_o";
		mKeyMap[Keys::KEY_P] = "key_p"; mKeyMap[Keys::KEY_Q] = "key_q"; mKeyMap[Keys::KEY_R] = "key_r";
		mKeyMap[Keys::KEY_S] = "key_s"; mKeyMap[Keys::KEY_T] = "key_t"; mKeyMap[Keys::KEY_U] = "key_u";
		mKeyMap[Keys::KEY_V] = "key_v"; mKeyMap[Keys::KEY_W] = "key_w"; mKeyMap[Keys::KEY_X] = "key_x";
		mKeyMap[Keys::KEY_Y] = "key_y"; mKeyMap[Keys::KEY_Z] = "key_z";
		mKeyMap[Keys::KEY_UP] = "key_up"; mKeyMap[Keys::KEY_DOWN] = "key_down";
		mKeyMap[Keys::KEY_LEFT] = "key_left"; mKeyMap[Keys::KEY_RIGHT] = "key_right";
		mKeyMap[Keys::KEY_SPACE] = "key_space";
		mKeyMap[Keys::KEY_0] = "key_0"; mKeyMap[Keys::KEY_1] = "key_1"; mKeyMap[Keys::KEY_2] = "key_2";
		mKeyMap[Keys::KEY_3] = "key_3"; mKeyMap[Keys::KEY_4] = "key_4"; mKeyMap[Keys::KEY_5] = "key_5";
		mKeyMap[Keys::KEY_6] = "key_6"; mKeyMap[Keys::KEY_7] = "key_7"; mKeyMap[Keys::KEY_8] = "key_8";
		mKeyMap[Keys::KEY_9] = "key_9";
		mKeyMap[Keys::KEY_F1] = "key_f1"; mKeyMap[Keys::KEY_F2] = "key_f2"; mKeyMap[Keys::KEY_F3] = "key_f3";
		mKeyMap[Keys::KEY_F4] = "key_f4"; mKeyMap[Keys::KEY_F5] = "key_f5"; mKeyMap[Keys::KEY_F6] = "key_f6";
		mKeyMap[Keys::KEY_F7] = "key_f7"; mKeyMap[Keys::KEY_F8] = "key_f8"; mKeyMap[Keys::KEY_F9] = "key_f9";
		mKeyMap[Keys::KEY_F10] = "key_f10"; mKeyMap[Keys::KEY_F11] = "key_f11"; mKeyMap[Keys::KEY_F12] = "key_f12";

		mMouseMap[Keys::MOUSE_LEFT] = "mouse_left"; mMouseMap[Keys::MOUSE_MIDDLE] = "mouse_middle";
	...
	void handleMouse(void* window)
	{
		...
		pCCamera->rotate(pCCamera->getUp(), toRadians(mouseXDelta * mouseSensitivity));		//this is ugly		

		dir.rotateSelf(pCCamera->getLeft(), -toRadians(mouseYDelta * mouseSensitivity));
		if (dir.getY() < 0.99f && dir.getY() > -0.99f)	//lock the camera so it doesn't fail - this is a ugly hack....
		{
