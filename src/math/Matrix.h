...
namespace Nova {
	...
	public:
		...
		static Mat4 makePerspectiveMatrix(const float vertFOV, const float aspectRatio, const float nearPlane, const float farPlane);
		static Mat4 makeOrthographicMatrix(const float width, const float height, const float nearPlane, const float farPlane);
		static Mat4 makeOrthographicMatrix(const float right, const float left, const float top, const float bottom, const float nearPlane, const float farPlane);
		...
		static Mat4 makeLookAtMatrix(const Vec3& positionVector, const Vec3& targetVector, const Vec3& upVector);
